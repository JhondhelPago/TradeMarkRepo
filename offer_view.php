                        ...
                        <div class="col-9 overflow-auto p-0 px-2 m-0 rounded" style="min-height: 85vh; max-height: 85vh;">
                            ...
                            <div class="container-fluid py-3 mt-1 rounded" style="background-color: white;">
                                ...
                                <div id="this_offer_userinfo" style="margin-left:2%; display:flex">
                                    ...
                                    <div style="width: 50%;">
                                    <h3 id="userInfo_username">Trader Username: <?php echo  $ThisOfferUserInfo->userInforamation->UserName;  ?></h3><br>
                                ...
                                <div class="container d-flex justify-content-center mt-5 gap-3" >
                                    <form class="container d-flex justify-content-center mt-5 gap-3" method="post" action="php/OfferAcceptDecline_Action.php">
                                        <input type="hidden" name="offer_id" value="<?php echo $OfferObject->get_offer_id(); ?>">
                                        <input type="hidden" name="selectedpost_id" value="<?php echo $OfferObject->selectedpost_id; ?>">
                                        <input class="btn btn-lg btn-warning w-100" type="submit" name="accept_submit" value="Accept">
                                        <input class="btn btn-lg btn-danger w-100" type="submit" name="decline_submit" value="Decline">
                                    </form>
                                </div>
