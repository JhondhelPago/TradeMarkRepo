                                    ...
                                    ?>
                                        ...
                                        <div class="row shadow justify-content-center align-items-center rounded bg-light">
                                            ...
                                            <div class="col-12 col-xl-5 justify-content-center align-items-center p-0 ms-3 ms-lg-1 m-3 d-inline-grid rounded" style="min-height: 10vh; max-height: 400px; min-width: 10vh; max-width: 400px;">
                                                <img class="img-fluid rounded" src="<?php echo "image-files/" . $UserOffer->PostObject->Display_Item_Thumbnail(); ?>" alt="Product Image" onclick="enlargeImg()" id="imgs" style="cursor:pointer;">
                                            </div>
                                            <!-- details -->
                                            <div class="col col-sm-12 col-xl py-2 d-grid">
                                                ...
                                                <div class="row justify-content-evenly align-items-center mb-2 m-0s">
                                                    ...
                                                    <form class="row col p-0 m-2" method="post" action="php/post_viewer_action.php">
                                                        <input type="hidden" name="post_id" value="<?php echo $UserOffer->PostObject->get_post_id(); ?>">
                                                        <button class="btn btn-outline-warning text-dark border border-dark rounded" type="submit" name="submit" >View Post Details</button>
                                                    </form> 
                                                </div>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                                ...
                                                <div class="row shadow justify-content-center align-items-center rounded bg-light">
                                                    <!-- pic -->
                                                    <div class="col-12 col-xl-5 justify-content-center align-items-center p-0 ms-3 ms-lg-1 m-3 d-inline-grid rounded" style="min-height: 10vh; max-height: 400px; min-width: 10vh; max-width: 400px;">
                                                        <img class="img-fluid rounded" src="<?php echo "image-files/" . $UserOffer->PostObject->Display_Item_Thumbnail(); ?>" alt="Item Image" style="min-height: 10vh; max-height: 400px; min-width: 10vh; max-width: 400px; cursor:pointer;" onclick="enlargeImg()" id="imgs">
                                                    ...
                                                    <div class="col col-sm-12 col-xl py-2 d-grid">
                                                        ...
                                                        <div class="row justify-content-evenly align-items-center m-0s">
                                                            ...
                                                            <form class="row col p-0 m-2" method="post" action="php/post_viewer_action.php">
                                                             ...
                                                             <form class="row col p-0 m-2" method="post" action="php/plain_viewer_action.php" >
                                                                            <input type="hidden" name="offer_id" value="<?php echo $UserOffer->OfferObject->get_offer_id(); ?>">
                                                                            <button class="btn text-dark" type="submit" name="viewer">View your Offer to this Post</button>
                                                            </form>
                                                        </div>
                                                        <div class="row fs-light mb-2">
                        ...
                        <?php
                            ...
                            ?>
                                ...
                                <div class="row shadow justify-content-center align-items-center rounded bg-light">
                                    <!-- pic -->
                                    <div class="col-12 col-xl-5 justify-content-center align-items-center p-0 ms-3 ms-lg-1 m-3 d-inline-grid rounded" style="min-height: 10vh; max-height: 400px; min-width: 10vh; max-width: 400px;">
                                        <img class="img-fluid rounded" src="<?php echo "image-files/" . $UserOffer->PostObject->Display_Item_Thumbnail(); ?>" alt="Item Image" onclick="enlargeImg()" id="imgs" style="cursor:pointer;">
                                        </div>
                                        <!-- details -->
                                        <div class="col col-sm-12 col-xl py-2 d-grid">
                                            <h1 class="display-6 fw-semibold mb-3"><?php echo $UserOffer->PostObject->itemName; ?></h1>
                                            ...
                                            <div class="row justify-content-evenly align-items-center m-0s">
                                                ...
                                                <form class="row col p-0 m-2" method="post" action="php/post_viewer_action.php">
                                                             ...
                                                             <form class="row col p-0 m-2" method="post" action="php/viewer_action.php" >
                                                                            <input type="hidden" name="offer_id" value="<?php echo $UserOffer->OfferObject->get_offer_id(); ?>">
                                                                            <button class="btn text-dark" type="submit" name="viewer">View your Offer to this Post</button>
                                                            </form>
                                    ...
                                    <div class="row shadow justify-content-center align-items-center rounded bg-light">
                                        <div class="col-12 col-sm">
                                            ...
                                            <div class="col-12 justify-content-center align-items-center p-0 mx-auto my-3 d-flex rounded" style="min-height: 10vh; max-height: 400px; min-width: 10vh; max-width: 300px;">
                                                <img class="img-fluid rounded" src="<?php echo "image-files/" . $PostAndOffer->PostObject->Display_Item_Thumbnail(); ?>" alt="Item Image" onclick="enlargeImg()" id="imgs" style="cursor:pointer;">
                                            </div>
                                            <!-- item details -->
                                            <div class="col col-sm-12 col-xl py-2 d-grid">
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                            ...
                                                            <div class="row justify-content-center align-items-center m-0 p-0 rounded shadow-sm text-center" style="background: linear-gradient(117deg, #3d52c927 40%, #593dc927 70%);">
                                                                ...
                                                                <div class="row col">
                                                                    <button class="row col p-0 m-2">Accept</button>
                                    ...
                                    <div class="row shadow justify-content-center align-items-center rounded bg-light">
                                        <div class="col-12 col-sm">
                                            ...
                                            <div class="col-12 justify-content-center align-items-center p-0 mx-auto my-3 d-flex rounded" style="min-height: 10vh; max-height: 400px; min-width: 10vh; max-width: 400px;">
                                                <img class="img-fluid rounded" src="<?php echo "image-files/". $PostAndOffer->PostObject->Display_Item_Thumbnail(); ?>" alt="Item Image" style="min-height: 10vh; max-height: 400px; min-width: 10vh; max-width: 400px; cursor:pointer;" onclick="enlargeImg()" id="imgs">
                                            </div>
                                            <!-- item details -->
                                            <div class="col col-sm-12 col-xl py-2 d-grid">
                                                <h1 class="fs-4 fw-semibold mb-3"><?php echo $PostAndOffer->PostObject->itemName; ?></h1>
                                                ...
                                                <div class="row fs-light mb-2">
                                                    ...
                                                    <form class="row col p-0 m-2" method="post" action="php/post_viewer_action.php">
                                                        <input type="hidden" name="post_id" value="<?php echo $PostAndOffer->PostObject->get_post_id(); ?>">
                                                        <button class="btn btn-outline-danger border border-dark text-black" type="submit" name="submit" >Cancel Post</button>
                                                    </form> 
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <div class="row justify-content-center align-items-center m-0 p-0 rounded shadow-sm" style="background: linear-gradient(117deg, #3d52c927 40%, #593dc927 70%);">
                                                    <img class="col img-fluid rounded p-0 m-2" src="<?php echo "offer-images-files/" . $Offer->Display_Item_Thumbnail(); ?>" alt="Trade Offer Image" style="max-width: 200px; cursor:pointer;" onclick="enlargeImg()" id="imgs">
                                                    <div class="row col-12 col-lg text-center">
                                                        ...
                                                        <form class="row col p-0 m-2" method="post" action="php/viewer_action.php">
                                                            ...
                                                            <button class="btn text-dark" type="submit" name="viewer">View Offer</button>
                                                        </form>
                                                    </div>
                                            <?php
                                                }
                                    ...
                                    <div class="row col-8 gap-3 d-grid overflow-auto m-0 my-2 p-3 rounded" style="max-height: 650px">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                    ...
                                                    <div class="row justify-content-center align-items-center m-0 p-0 rounded shadow-sm" style="background: linear-gradient(117deg, #3d52c927 40%, #593dc927 70%);">
                                                        <img class="col-6 img-fluid rounded p-0 m-2" src="<?php echo "offer-images-files/" . $Offer->Display_Item_Thumbnail(); ?>" alt="Trade Offer Image" style="max-width: 200px; cursor:pointer;" onclick="enlargeImg()" id="imgs">
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <form class="col btn btn-outline-success text-dark border border-dark rounded m-2" method="post" action="php/completed_action_form.php" >
                                                                        <input type="hidden" name="offer_id" value="<?php echo $Offer->get_offer_id(); ?>">
                                                                        <input type="hidden" name="post_id" value="<?php echo $PostAndOffer->PostObject->get_post_id(); ?>">
                                                                        <button class="btn text-dark" type="submit" name="complete_submit">Complete</button>
                                                                    </form>
                                                                <?php
                                                                }
                                                                ?>
