                    ...
                    <div class="row justify-content-center align-items-center p-1" >
                        ...
                        <div class="col-9 overflow-auto p-0 px-2 m-0 rounded" style="min-height: 85vh; max-height: 85vh;">
                            ...
                            <div class="container-fluid py-3 mt-1 rounded" style="background-color: white;">
                                ...
                                <!-- method -->
                                <h3 class="text-center pb-3 mx-3 fw-semibold">Trade with Top Up</h3>
                                ...
                                <div class="row gap-3 mx-3">
                                    ...
                                    <div class="col-sm-12 col-md d-flex align-items-center justify-content-center rounded pt-2 p-1 m-0" style="background-color: #7c62e42f;">
                                        <h6 class="lh-base fw-normal text-center">Location: <?php echo $TraderInformation->Address; ?></h6>
                                    </div>
                            ...
                            <div class="row rounded p-0 pb-2 m-0 mt-4 overflow-auto" style="background-color: white;">
                                ...
                                <div class="container d-flex gap-2 mt-3">
                                    <form class="container" enctype="multipart/form-data" method="post" action="php/new_topup_form_action.php">
                                    ...
                                    <input class="form-control border border-dark text-dark w-100" placeholder="Item Name" type="text" name="itemName"> <br>
                                        ...
                                        <input class="form-control border border-dark text-dark w-100" style="" id="add_img" value="Add Image" type="file" name="uploadImg[]" accept=".jpg, .jpeg, .png" multiple></input>
                                        ...
                                        <!-- top up amount (comment) -->
                                        <div class="form-floating my-3">
                                            <input class="form-control border border-dark rounded lead" placeholder="How much would you like to add?" id="top_up_amt" type="number" name="topup_amount"></input>
                                            <label for="top_up_amt">Top-up Amount</label>
                                        </div>

                                        <!-- desc (comment) -->
                                        <div class="form-floating my-3">
                                            <textarea class="form-control border border-dark rounded lead" style="height: 200px;" placeholder="Put a description on your item/s." id="desc" name="itemDescrip"></textarea>
                                            <label for="desc">Description</label>
                                        </div>

                                        <div class="container d-flex justify-content-center my-4">
                                            <input class="btn btn-lg btn-warning w-100" type="submit" value="Send Offer" name="submit">
                                        </div>
                                    </form>
