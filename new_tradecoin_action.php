                    ...
                    <div class="row justify-content-center align-items-center p-1" >
                        ...
                        <div class="col-9 overflow-auto p-0 px-2 m-0 rounded" style="min-height: 85vh; max-height: 85vh;">
                            ...
                            <div class="container-fluid py-3 mt-1 rounded" style="background-color: white;">
                                ...
                                <!-- method -->
                                <h3 class="text-center pb-3 mx-3 fw-semibold">₱<?php echo $itemInformation->price; ?></h3>
                                ...
                                <div class="row justify-content-center text-center mt-5 gap-2" >
                                    <form method="post" class="tradecoin_action_form_class col-12" action="php/new_tradecoin_form_action.php">
                                        <input type="text" value="<?php echo $itemInformation->price; ?>" name="price_amount" hidden>
                                        <input class="btn btn-lg btn-warning w-100" type="submit" value="Buy with TradeCoin" name="submit">
                                    </form>
                                    <p class="col-12 fw-light">Your offer will only queue to trader if you have <span class="fw-semibold">sufficient TradeCoin balance</span>.</p>
                                </div>
                            </div>
