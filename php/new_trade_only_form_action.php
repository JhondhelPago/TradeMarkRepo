<?php
// this file handles the fomr submission of the new_trade_only_action.php
...
//this are the attribute of the offer_trade_only table
$id = 0;
...
if(isset($_POST['submit'])){
    //palcing the form value to the variables
