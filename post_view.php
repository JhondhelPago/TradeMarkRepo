...
$Post_id = $_SESSION['idForPostViewer'];
...
$ThisPostUserObject = new UserInfoRetriever($PostObject->get_email());
                ...
                <div class="col col-md-10 " style="margin-top: 90px;">
                    <div class="row justify-content-center align-items-center p-1" >
                        ...
                        <div class="pic_zoom col p-1 pe-2 gap-2 d-inline-grid overflow-auto rounded" style="max-height: 85vh; max-width: 400px;">
                            ...
                            <?php
                                foreach($PostObject->imageArray as $imagefilename){
                                ?>
                                    <img class="img-fluid rounded" src="<?php echo "image-files/" . $imagefilename; ?>" alt="Product Image">
                        ...
                        <div class="col-9 overflow-auto p-0 px-2 m-0 rounded" style="min-height: 85vh; max-height: 85vh;">
                            ...
                            <div class="container-fluid py-3 mt-1 rounded" style="background-color: white;">
                                <!-- product name -->
                                <h1 class="display-5 fw-semibold text-center rounded py-2"><?php echo $PostObject->itemName; ?></h1>

                                <!-- method -->
                                <h5 class="text-center pb-3 mx-3 fw-semibold" style="font-size: 1.75rem;"></h5>
                                ...
                                <div class="row gap-3 mx-3">
                                    <div class="col-sm-12 col-md d-flex align-items-center justify-content-center rounded pt-2 p-1 m-0" style="background-color: #8393ec2f;">
                                        <h5 class="lh-base fw-light text-center">Condition:  
                                        <em> (<?php echo $PostObject->item_condition; ?>) </em>
                                        </h5>
                                    </div>
                                    <div class="col-sm-12 col-md d-flex align-items-center justify-content-center rounded pt-2 p-1 m-0" style="background-color: #7c62e42f;">
                                        <h5 class="lh-base fw-light text-center"><?php echo $PostObject->payment_method; ?></h5>
                                    </div>
                                    <div class="col-sm-12 col-md d-flex align-items-center justify-content-center rounded pt-2 p-1 m-0" style="background-color: #ac55df2f;">
                                        <h5 class="lh-base fw-light text-center"><?php echo $PostObject->category;  ?></h5>
                                    </div>
                                </div>

                                <h5 style="margin-left: 1%; margin-top: 5%;">Desired Top-up Amount:  <em style="color:green;">₱<?php echo $PostObject->price; ?></em></h5>

                                <h6 class="fw-bold p-3 pt-4 pb-0 mb-3" style="font-size: 1.2em;">Description:</h6>
                                <p class="p-3 py-2 mx-2 mt-2 overflow-auto rounded lead" style="max-height: 300px; font-size: 1.8em;"><?php echo $PostObject->description;  ?></p>

                                <div id="this_offer_userinfo" style="margin-left:2%; display:flex ; margin-top:5%; border-top: solid 3px blue; padding-top: 2%;">
                                    
                                    <div style="width: 50%; font-size:1.5em; ">
                                    <p id="userInfo_username" >Trader Username: <?php echo  $ThisPostUserObject->userInforamation->UserName;  ?></p>
                                    
                                    
                                    <p>Trader Badge(<?php echo $ThisPostUserObject->userInforamation->Rating; ?>)
                                        <?php StarBadge::ReturnBadge((float)$ThisPostUserObject->userInforamation->Rating) ;?>
                                    <p>

                                    <p>Address: <?php echo $ThisPostUserObject->userInforamation->Address; ?></p>
                                    <p>City: <?php echo $ThisPostUserObject->userInforamation->City; ?></p>
                                
                                    </div>

                                    <div style="font-size:1.5em;">
                                        <p>Contact Information</p>
                                        <p>Email:<em> <?php echo $ThisPostUserObject->userInforamation->Email; ?> </em></p>
                                        <p>Mobile Number:<em> <?php echo $ThisPostUserObject->userInforamation->Mobile_number;  ?> </em> </p>
                                    </div>
                                </div>
